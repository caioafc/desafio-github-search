...
class MainActivity : AppCompatActivity() {
    ...
    private fun showUserName(): String {
        ...
        return sharedPref.getString(R.string.nome_usuario.toString(), "").toString()
    }
    ...
    fun getAllReposByUserName() {
        githubApi.getAllRepositoriesByUser(showUserName()).enqueue(object : Callback<List<Repository>> {
